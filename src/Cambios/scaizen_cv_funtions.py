...
class DailyReportFuntions():
    ...
    def __OrderDataReportComplement(self,reports,tipo_operacion,operacion):
        complementos = []
    ...
    def GetComplementDailyReportAll(self, date,date2,tipo_operacion,operacion):
        reports = cv.Complemento.select_by_id_tipo(date,date2)
        return self.__OrderDataReportComplement(reports,tipo_operacion,operacion)
